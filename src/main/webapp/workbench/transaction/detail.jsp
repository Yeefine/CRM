<%@ page import="com.myProject.crm.settings.domain.DicValue" %>
<%@ page import="java.util.List" %>
<%@ page import="java.util.Map" %>
<%@ page import="java.util.Set" %>
<%@ page import="com.myProject.crm.workbench.domain.Tran" %>
	...
	<div style="position: relative; left: 40px; top: -50px;">
		...
		<%
			...
			if ("0".equals(currentPossibility)) {
				for (int i = 0; i < dvList.size(); i++) {	// 遍历每一阶段

					DicValue dv = dvList.get(i);
					String listStage = dv.getValue();
					String listPossibility = pMap.get(listStage);

					if ("0".equals(listPossibility)) {	// 遍历阶段的可能性为0
						if (listStage.equals(currentStage)) {	// 遍历阶段等于当前阶段
							// 红叉
		%>
		...
		<%
				...
				for (int i = 0; i < dvList.size(); i++) {    // 遍历每一阶段
					...
					if ("0".equals(listPossibility)) {	// 可能性为0的阶段
						// 黑叉
		%>
